...
- (void)pushTransactionRequestOperation{
    ...
    Sha256 *sha256 = [[Sha256 alloc] initWithData:[RIXByteWriter getBytesForSignature:self.chain_Id andParams: [[self.getRequiredPublicKeyRequest parameters] objectForKey:@"transaction"] andCapacity:255]];
    ...
    if (recId == -1 ) {
        ...
        NSString *packed_trxHexStr = [[RIXByteWriter getBytesForSignature:nil andParams: [[self.getRequiredPublicKeyRequest parameters] objectForKey:@"transaction"] andCapacity:512] hexadecimalString];
