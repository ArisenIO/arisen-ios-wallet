...
- (void)configHeaderView{
    self.headerView.assestsNameLabel.text =  IsNilOrNull(self.currentToken) ? SymbolName_RIX : self.currentToken.token_symbol;
    self.headerView.contractNameLabel.text = [NSString stringWithFormat:@"(%@)", IsNilOrNull(self.currentToken) ? ContractName_ARISENTOKEN : self.currentToken.contract_name];
}
