...
- (void)getRate{
    WS(weakSelf);
    if ([self.redPacketModel.coin isEqualToString:SymbolName_RIX]) {
        self.transferService.getRateRequest.coinmarket_id = @"RIX";
        ...
        self.transferService.getRateRequest.coinmarket_id = @"cet_RIX";
    }
