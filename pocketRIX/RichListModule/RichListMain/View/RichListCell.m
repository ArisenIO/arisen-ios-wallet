...
-(void)setWalletAccount:(WalletAccount *)walletAccount{
    ...
    _titleLabel.text = walletAccount.RIXAccountName;
    [_avatarImg sd_setImageWithURL: String_To_URL(walletAccount.RIXAccountName) placeholderImage:[UIImage imageNamed:@"account_default_blue"]];
