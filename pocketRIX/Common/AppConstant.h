...
//#define ACCOUNT_REGISTER_URL @"http://59.110.162.106:8001/rix_account_service/v1.0.0/register"
...
// 账号注册地址
#define REQUEST_APIPATH [NSString stringWithFormat: @"/app_api/v1.0.0%@", [self requestUrlPath]]
#define ACCOUNT_REGISTER_URL @"http://39.106.118.225:8080/v1.0.0/rix_account_service/register"
