...
- (void)validateInputFormat{
    // 验证私钥格式是否正确
    private_Key_1_is_validate = [RIX_Key_Encode validateWif:self.headerView.textView1.text];
    private_Key_2_is_validate = [RIX_Key_Encode validateWif:self.headerView.textView2.text];
...
- (void)createPublicKeys{
    // 将用户导入的私钥生成公钥
    public_key_1_from_local = [RIX_Key_Encode RIX_publicKey_with_wif:self.headerView.textView1.text];
    public_key_2_from_local = [RIX_Key_Encode RIX_publicKey_with_wif:self.headerView.textView2.text];
