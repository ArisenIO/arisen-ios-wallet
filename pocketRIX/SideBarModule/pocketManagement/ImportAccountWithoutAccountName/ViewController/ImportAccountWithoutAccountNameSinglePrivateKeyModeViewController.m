...
- (void)validateInputFormat{
    // 验证私钥格式是否正确
    private_Key_1_is_validate = [RIX_Key_Encode validateWif:self.headerView.textView.text];
...
- (void)createPublicKeys{
    // 将用户导入的私钥生成公钥
    public_key_1_from_local = [RIX_Key_Encode RIX_publicKey_with_wif:self.headerView.textView.text];
