//
//  RIXResourceManageViewController.m
//  pocketRIX
//
...
@interface RIXResourceManageViewController ()<PageSegmentViewDelegate, UINavigationControllerDelegate, CommonDialogHasTitleViewDelegate>
@property(nonatomic, strong) NavigationView *navView;
@property(nonatomic , strong) RIXResourceService *mainService;
...
@implementation RIXResourceManageViewController
...
- (RIXResourceService *)mainService{
    if (!_mainService) {
        _mainService = [[RIXResourceService alloc] init];
    }
    return _mainService;
}
...
- (void)buildDataSource{
    ...
    [self.mainService get_account:^(RIXResourceResult *result, BOOL isSuccess) {
        if (isSuccess) {
