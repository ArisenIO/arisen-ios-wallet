...
- (void)createkeys{
    ...
    weakSelf.vipRegistAccountService.inviteCodeRegisterRequest.RIXAccountName = weakSelf.headerView.accountNameTF.text;
    weakSelf.vipRegistAccountService.inviteCodeRegisterRequest.ownerKey = ownerPrivateKey.RIXPublicKey;
    weakSelf.vipRegistAccountService.inviteCodeRegisterRequest.activeKey = activePrivateKey.RIXPublicKey;
    ...
    [weakSelf.vipRegistAccountService createRIXAccount:^(id service, BOOL isSuccess) {
