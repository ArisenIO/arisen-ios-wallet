...
-(void)buildDataSource:(CompleteBlock)complete{
    ...
    NSMutableArray *itemDetailArr = [NSMutableArray arrayWithObjects:NSLocalizedString(@"使用已有的RIX账号", nil), NSLocalizedString(@"支付费用创建新RIX账号", nil), NSLocalizedString(@"填写注册码免费创建RIX账号", nil), NSLocalizedString(@"不定期开放，敬请关注", nil), nil];
