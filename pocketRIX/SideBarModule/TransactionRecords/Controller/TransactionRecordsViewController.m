...
- (void)requestTransactionHistory{
    ...
    self.mainService.getTransactionRecordsRequest.symbols = [NSMutableArray arrayWithObjects:@{@"symbolName":@"RIX"  , @"contractName": ContractName_ARISENTOKEN }, @{@"symbolName":@"OCT"  , @"contractName": ContractName_OCTOTHEMOON },nil];
    [self loadNewData];
}
