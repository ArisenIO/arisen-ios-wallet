...
- (Get_pocketrix_info_request *)get_pocketrix_info_request{
    if (!_get_pocketrix_info_request) {
        _get_pocketrix_info_request = [[Get_pocketrix_info_request alloc] init];
    }
    return _get_pocketrix_info_request;
}
...
- (void)buildDataSource{
    WS(weakSelf);
    [self.get_pocketrix_info_request getDataSusscess:^(id DAO, id data) {
        Get_pocketrix_info_Result *result = [Get_pocketrix_info_Result mj_objectWithKeyValues:data];
