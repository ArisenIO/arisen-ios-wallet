...
- (WKWebView *)webView{
    if (!_webView) {
        ...
        if (@available(iOS 9.0, *)) {
            self.webView.customUserAgent = @"PocketARISENs"; //tokenpocket
        } else {
            // Fallback on earlier versions
        }
    }
...
-(void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message{
    ...
    if ([result[0] containsString:@"pair"]) {
        ...
        if ([result1_tojsonStr containsString:@"identityFromPermissions"] || [result1_tojsonStr containsString:@"authenticate"]
            ...
            [resultDict setObject:@"PocketRix" forKey:@"name"];
            ...
            [accountDict setObject:@"Rix" forKey:@"blockchain"];
...
- (void)loadWebView{
    //https://dapp.newdex.io/    https://game.wizards.one/#/ https://app.dRixgames.com/en/slots/dRix  https://pixelmaster.io/ https://www.xpet.io/
    NSString *requestStr;
