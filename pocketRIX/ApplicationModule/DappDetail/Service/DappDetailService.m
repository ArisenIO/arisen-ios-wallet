...
- (void)getAppInfo:(CompleteBlock)complete{
    ...
    [dataDict setValue: VALIDATE_STRING(@"PocketARISENS") forKey:@"app"];
...
- (void)getRixAccount:(CompleteBlock)complete{
    NSMutableDictionary *resultDict = [[NSMutableDictionary alloc] init];
    [resultDict setValue:@0 forKey:@"code"];
    [resultDict setValue:VALIDATE_STRING(@"success") forKey:@"message"];
...
- (void)getRixBalance:(CompleteBlock)complete{
    WS(weakSelf);
...
- (void)getRixAccountInfo:(CompleteBlock)complete{
